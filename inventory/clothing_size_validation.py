...
def validate_clothing_size(
    ...
    Args:
        ...
        allow_blank: If True, empty size is allowed. Default False (size required).
    ...
    # Empty size handling: only allowed if explicitly permitted
    if not size:
        if allow_blank:
            return True, ""
