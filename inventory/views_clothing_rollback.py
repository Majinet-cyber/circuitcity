...
def clothing_rollback_sale(request: HttpRequest, sale_id: int) -> HttpResponse:
    ...
    try:
        ...
        messages.success(request, f"✅ Clothing sale #{sale_id} rolled back successfully!")
...
def clothing_rollback_confirm(request: HttpRequest, sale_id: int) -> HttpResponse:
    ...
    try:
        ...
        sale = get_object_or_404(
            ClothingSale.objects.select_related("product", "sold_by"), pk=sale_id, business=business
        )
