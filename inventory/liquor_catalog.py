...
CATEGORY_METADATA = {
    "beer": {"label": "Beer", "icon": "🍺", "description": "Beers and lagers"},
    "cider": {"label": "Cider", "icon": "🍎", "description": "Ciders and flavored drinks"},
    "wine": {"label": "Wine", "icon": "🍷", "description": "Red, white, and rosé wines"},
    "spirits": {"label": "Spirits", "icon": "🥃", "description": "Liqueurs and specialty spirits"},
    "whiskey": {"label": "Whiskey", "icon": "🥃", "description": "Whiskey and bourbon"},
    "gin": {"label": "Gin", "icon": "🍸", "description": "Gin and gin-based drinks"},
    "vodka": {"label": "Vodka", "icon": "🧊", "description": "Vodka and vodka mixes"},
    "rum": {"label": "Rum", "icon": "🏝️", "description": "Light and dark rum"},
    "brandy": {"label": "Brandy", "icon": "🍇", "description": "Brandy and cognac"},
    "tequila": {"label": "Tequila", "icon": "🌵", "description": "Tequila and mezcal"},
    "mixers": {"label": "Mixers", "icon": "🧃", "description": "Soft drinks and mixers"},
    "energy": {"label": "Energy Drinks", "icon": "⚡", "description": "Energy and sports drinks"},
    "water": {"label": "Water", "icon": "💧", "description": "Still and sparkling water"},
    "other": {"label": "Other", "icon": "📦", "description": "Other beverages"},
}
...
def get_category_metadata(category: str) -> dict:
    ...
    """
    category = str(category).lower().strip()
    return CATEGORY_METADATA.get(category, {"label": category.title(), "icon": "📦", "description": category.title()})
