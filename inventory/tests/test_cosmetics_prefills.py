...
class CosmeticsPrefillsTestCase(TestCase):
    ...
    def test_management_command_creates_prefills(self):
        ...
        out = StringIO()
        call_command("seed_cosmetics_products", f"--business-id={self.business.id}", stdout=out)
    ...
    def test_management_command_is_idempotent(self):
        ...
        call_command("seed_cosmetics_products", f"--business-id={self.business.id}", stdout=StringIO())
    ...
    def test_prefills_are_tenant_scoped(self):
        ...
        call_command("seed_cosmetics_products", f"--business-id={business2.id}", stdout=StringIO())
