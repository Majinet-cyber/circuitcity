...
class PharmacyWizardCosmeticsFlowTest(TestCase):
    ...
    def setUp(self):
        ...
        self.business = Business.objects.create(
            name="Test Pharmacy", slug="test-pharmacy", business_kind="pharmacy", status="ACTIVE", created_by=self.user
        )
    ...
    def test_cosmetics_step2_shows_prefills_when_db_empty(self):
        ...
        response = self.client.post(
            self.wizard_url, {"wizard_step": "0", "selected_mode": "cosmetics", "action": "next"}
        )
        ...
        response = self.client.post(
            self.wizard_url,
            {"wizard_step": "1", "selected_mode": "cosmetics", "selected_category": "body_care", "action": "next"},
        )
        self.assertEqual(response.status_code, 302)
    ...
    def test_cosmetics_step2_combines_db_and_prefills(self):
        ...
        self.client.post(self.wizard_url, {"wizard_step": "0", "selected_mode": "cosmetics", "action": "next"})
        self.client.post(
            self.wizard_url,
            {"wizard_step": "1", "selected_mode": "cosmetics", "selected_category": "body_care", "action": "next"},
        )
    ...
    def test_save_creates_merchproduct_if_missing(self):
        ...
        self.assertFalse(MerchProduct.objects.filter(name="Body Spray", business=self.business).exists())
        ...
        product = MerchProduct.objects.filter(
            name="Body Spray", business=self.business, kind="pharmacy", category=PharmacyCategory.PERSONAL_CARE
        ).first()
    ...
    def test_cosmetics_expiry_date_optional(self):
        ...
        self.client.post(
            self.wizard_url,
            {"wizard_step": "1", "selected_mode": "cosmetics", "selected_category": "makeup", "action": "next"},
        )
        self.client.post(
            self.wizard_url,
            {
...
class PharmacyWizardMedicinesFlowTest(TestCase):
    ...
    def test_pharmacy_medicines_flow_works_end_to_end(self):
        ...
        response = self.client.post(
            self.wizard_url, {"wizard_step": "0", "selected_mode": "pharmacy", "action": "next"}
        )
        self.assertEqual(response.status_code, 302)
        ...
        response = self.client.post(
            self.wizard_url,
            {"wizard_step": "1", "selected_mode": "pharmacy", "selected_category": "first_aid", "action": "next"},
        )
        self.assertEqual(response.status_code, 302)
        ...
        has_content = response.context.get("subcategories") or response.context.get("items")
    ...
    def test_pharmacy_requires_expiry_date(self):
        ...
        self.client.post(self.wizard_url, {"wizard_step": "0", "selected_mode": "pharmacy", "action": "next"})
        self.client.post(
            self.wizard_url,
            {"wizard_step": "1", "selected_mode": "pharmacy", "selected_category": "first_aid", "action": "next"},
        )
...
class PharmacyWizardButtonFlowTest(TestCase):
    ...
    def test_back_button_returns_to_previous_step(self):
        ...
        # Click "Back"
        response = self.client.post(self.wizard_url, {"wizard_step": "2", "action": "back"})
        self.assertEqual(response.status_code, 302)
