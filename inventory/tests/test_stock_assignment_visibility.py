...
class StockListAssignedRoleVisibilityTest(TestCase):
    ...
    def test_stock_list_view_loads_without_500(self):
        ...
        self.assertIn(
            ...
            [200, 302],
            f"Stock list returned {response.status_code}, expected 200 or 302"
        )
    ...
    def test_queryset_filtering_for_agent(self):
        ...
        agent_items = InventoryItem.objects.filter(
            ...
            Q(assigned_agent=self.agent) | Q(assigned_role="AGENT")
        )
    ...
    def test_agent_cannot_see_manager_items(self):
        ...
        self.assertNotIn(
            self.item_for_manager,
            agent_visible,
            "Agent should not see items with assigned_role='MANAGER'"
        )
    ...
    def test_assigned_role_index_exists(self):
        ...
        self.assertTrue(
            field.db_index,
            "assigned_role field should have db_index=True for performance"
        )
