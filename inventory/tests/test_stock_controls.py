...
class StockControlsTestCase(TransactionTestCase):
    ...
    def test_manager_can_transfer_stock(self):
        ...
        response = self.client.post(
            reverse("inventory:transfer_stock", args=[self.stock_manager.id]), {"agent_id": self.agent2.id}
        )
    ...
    def test_manager_can_transfer_to_manager_pool(self):
        ...
        response = self.client.post(
            reverse("inventory:transfer_stock", args=[self.stock_agent1.id]), {"agent_id": "none"}
        )
    ...
    def test_agent_cannot_transfer_stock(self):
        ...
        response = self.client.post(
            reverse("inventory:transfer_stock", args=[self.stock_agent1.id]), {"agent_id": self.agent2.id}
        )
    ...
    def test_manager_can_edit_imei(self):
        ...
        response = self.client.post(reverse("inventory:edit_imei", args=[self.stock_manager.id]), {"imei": new_imei})
    ...
    def test_edit_imei_rejects_invalid_format(self):
        ...
        # Too short
        response = self.client.post(reverse("inventory:edit_imei", args=[self.stock_manager.id]), {"imei": "12345"})
        self.assertEqual(response.status_code, 400)

        # Contains letters
        response = self.client.post(
            reverse("inventory:edit_imei", args=[self.stock_manager.id]), {"imei": "12345678901234A"}
        )
        self.assertEqual(response.status_code, 400)
    ...
    def test_edit_imei_rejects_duplicate(self):
        ...
        response = self.client.post(
            reverse("inventory:edit_imei", args=[self.stock_manager.id]), {"imei": self.stock_agent1.imei}
        )
    ...
    def test_agent_cannot_edit_imei(self):
        ...
        response = self.client.post(
            reverse("inventory:edit_imei", args=[self.stock_agent1.id]), {"imei": "111111111111111"}
        )
    ...
    def test_manager_can_archive_stock(self):
        ...
        response = self.client.post(reverse("inventory:archive_stock", args=[self.stock_manager.id]))
    ...
    def test_manager_can_restore_archived_stock(self):
        ...
        # Restore it
        response = self.client.post(reverse("inventory:restore_stock", args=[self.stock_manager.id]))
    ...
    def test_agent_cannot_archive_stock(self):
        ...
        response = self.client.post(reverse("inventory:archive_stock", args=[self.stock_agent1.id]))
    ...
    def test_agent_cannot_restore_stock(self):
        ...
        response = self.client.post(reverse("inventory:restore_stock", args=[self.stock_agent1.id]))
