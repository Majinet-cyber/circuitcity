...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name="merchproduct",
            name="has_sizes",
            field=models.BooleanField(default=False, help_text="Enable size variants for this product"),
        ),
        migrations.AddField(
            model_name="merchproduct",
            name="has_colors",
            field=models.BooleanField(default=False, help_text="Enable color variants for this product"),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "size",
                    models.CharField(
                        blank=True, default="", max_length=20, help_text="Size for this variant (e.g., M, 42)"
                    ),
                ),
                ("color", models.CharField(blank=True, default="", max_length=50, help_text="Color for this variant")),
                (
                    "variant_sku",
                    models.CharField(blank=True, default="", max_length=100, help_text="Auto-generated variant SKU"),
                ),
                (
                    "quantity_in_stock",
                    models.PositiveIntegerField(default=0, help_text="Stock quantity for this variant"),
                ),
                (
