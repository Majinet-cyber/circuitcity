    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "is_archived",
                    models.BooleanField(
                        db_index=True, default=False, help_text="Set to True to archive this barcode without deleting"
                    ),
                ),
                (
                    "archived_at",
                    models.DateTimeField(
                        blank=True, db_index=True, help_text="When this barcode was archived", null=True
                    ),
                ),
                (
                    "business",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "model_name",
                    models.CharField(help_text="Model name (e.g., 'ThinkPad X1', 'MacBook Pro 13')", max_length=100),
                ),
                (
                    "ram",
                    models.CharField(
                        blank=True, help_text="RAM specification (e.g., '8GB', '16GB DDR4')", max_length=50
                    ),
                ),
                (
                    "storage",
                    models.CharField(
                        blank=True, help_text="Storage specification (e.g., '256GB SSD', '1TB HDD')", max_length=50
                    ),
                ),
                (
                    "battery_life",
                    models.CharField(blank=True, help_text="Battery life (e.g., '8 hours', '12 hours')", max_length=50),
                ),
                (
                    "default_cost_price",
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Default cost price for this model",
                        max_digits=10,
                        null=True,
                    ),
                ),
                (
                    ...
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Default selling price for this model",
                        max_digits=10,
                        null=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "received_at",
                    models.DateField(
                        default=django.utils.timezone.localdate, help_text="Date laptop was received/stocked"
                    ),
                ),
                (
                    "order_price",
                    models.DecimalField(
                        decimal_places=2, default=0, help_text="Cost price when purchased", max_digits=12
                    ),
                ),
                (
                    "selling_price",
                    models.DecimalField(
                        blank=True,
                        decimal_places=2,
                        help_text="Selling price (can override product default)",
                        max_digits=12,
                        null=True,
                    ),
                ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="archived_laptop_serials",
                        to="auth.user",
                    ),
                ),
                (
                ...
                (
                    "product",
                    models.ForeignKey(
                        help_text="Laptop product model",
                        on_delete=django.db.models.deletion.PROTECT,
                        related_name="serials",
                        to="inventory.laptopproduct",
                    ),
                ),
            ],
            options={
