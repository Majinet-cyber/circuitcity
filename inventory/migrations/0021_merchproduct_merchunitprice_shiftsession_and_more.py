    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "base_unit",
                    models.CharField(
                        choices=[("unit", "Unit"), ("shot", "Shot"), ("ml", "ml"), ("g", "g")],
                        default="unit",
                        max_length=10,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "last_status",
                    models.CharField(
                        blank=True, choices=[("inside", "Inside"), ("outside", "Outside")], max_length=8, null=True
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                blank=True, choices=[("start", "Start"), ("ping", "Ping"), ("end", "End")], max_length=10
            ),
        ),
        migrations.AddField(
            model_name="timelog",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="tenants.business"
            ),
        ),
        migrations.AddField(
            model_name="shiftsession",
            name="location",
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="inventory.location"
            ),
        ),
        migrations.AddField(
            model_name="shiftsession",
            name="user",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="shift_sessions", to=settings.AUTH_USER_MODEL
            ),
        ),
        migrations.AddField(
            ...
            name="product",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="unit_prices", to="inventory.merchproduct"
            ),
        ),
        migrations.AddField(
            ...
            name="business",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name="merch_products", to="tenants.business"
            ),
        ),
        migrations.CreateModel(
