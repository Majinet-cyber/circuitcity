...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name="liquorsale",
            name="rolled_back_at",
            field=models.DateTimeField(null=True, blank=True, help_text="When this sale was rolled back"),
        ),
        migrations.AddField(
            model_name="liquorsale",
            name="rolled_back_by",
        ...
        migrations.AddField(
            ...
            field=models.CharField(max_length=50, blank=True, default="", help_text="Reason for rollback"),
        ),
        migrations.AddField(
            model_name="liquorsale",
            name="rollback_notes",
            field=models.TextField(blank=True, default="", help_text="Additional notes about the rollback"),
        ),
