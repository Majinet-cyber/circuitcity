    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                blank=True, default="", help_text="Liquor category: beer, cider, spirits, wine, other", max_length=20
            ),
        ),
        migrations.AddField(
            model_name="merchproduct",
        ...
        migrations.AddField(
            ...
            field=models.DecimalField(
                blank=True, decimal_places=2, help_text="Price for a full bottle", max_digits=10, null=True
            ),
        ),
        migrations.AddField(
            model_name="merchproduct",
            name="price_per_shot",
            field=models.DecimalField(
                blank=True, decimal_places=2, help_text="Price per individual shot", max_digits=10, null=True
            ),
        ),
        migrations.AddField(
            model_name="merchproduct",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                ...
                related_name="archived_merch_products",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "unit",
                    models.CharField(choices=[("bottle", "Bottle"), ("shot", "Shot")], default="bottle", max_length=10),
                ),
                ...
                (
                    "sale_type",
                    models.CharField(
                        choices=[("sale", "Cash Sale"), ("credit", "Credit Sale"), ("undecided", "Undecided")],
                        default="sale",
                        max_length=10,
                    ),
                ),
                ...
                (
                    "business",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="liquor_sales", to="tenants.business"
                    ),
                ),
                (
                    "product",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="liquor_sales_made",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="liquor_credits_created",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="liquor_payments_submitted",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="liquor_payments_reviewed",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="liquor_stock_requests",
                        to="tenants.business",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="liquor_stock_requests_submitted",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="liquor_stock_requests_reviewed",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="liquor_expenses_created",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="liquor_wallet_entries",
                        to="tenants.business",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="liquor_wallet_entries_created",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="inventory.liquorcreditpayment",
                    ),
                ),
                (
                    "related_sale",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "business",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="gym_members", to="tenants.business"
                    ),
                ),
                (
                    "archived_by",
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="gym_members_archived",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "member",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="payments", to="inventory.gymmember"
                    ),
                ),
                (
                    "paid_by",
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="gym_payments_collected",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "member",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="logs", to="inventory.gymmember"
                    ),
                ),
                (
                    "performed_by",
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="gym_member_logs_created",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(decimal_places=2, default=Decimal("50000.00"), max_digits=10),
                ),
                (
                    "arrears_message",
                    models.TextField(default="Your membership is in arrears. Please contact us to renew."),
                ),
                (
                    "business",
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, related_name="gym_settings", to="tenants.business"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="gym_wallet_entries",
                        to="tenants.business",
                    ),
                ),
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="gym_wallet_entries_created",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="clothing_logs_created",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="clothing_sales_made",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
