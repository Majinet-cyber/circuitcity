    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.DateField(
                null=True,
                blank=True,
                help_text='Start date of current membership period'
            ),
        ),
        migrations.AddField(
            model_name='gymmember',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business', models.ForeignKey(on_delete=models.CASCADE, related_name='gym_checkins', to='tenants.business')),
                ('location', models.ForeignKey(blank=True, null=True, on_delete=models.SET_NULL, related_name='gym_checkins', to='inventory.location')),
                ('member', models.ForeignKey(on_delete=models.CASCADE, related_name='checkins', to='inventory.gymmember')),
                ('checked_in_by', models.ForeignKey(blank=True, null=True, on_delete=models.SET_NULL, related_name='gym_checkins_performed', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-timestamp'],
                'indexes': [
