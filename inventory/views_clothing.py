...
def stock_list(request):
    ...
    return render(request, "inventory/clothing/stock_list.html", {
        "products": products,
        "business": business,
...
def archived_products(request):
    ...
    return render(request, "inventory/clothing/archived_products.html", {
        "products": products,
        "business": business,
    })
...
def sell_clothing(request):
    ...
    recent_sales = ClothingSale.objects.filter(business=business).select_related("product", "sold_by").order_by("-sold_at")[:10]
    
    return render(request, "inventory/clothing/sell.html", {
        "form": form,
...
def sales_list(request):
    ...
    return render(request, "inventory/clothing/sales_list.html", {
        "sales": sales,
        "business": business,
    })
...
def clothing_dashboard(request):
    ...
    total_stock_value = products.aggregate(
        total=Sum(F("price_per_bottle") or Decimal("0.00"))
...
def product_logs(request, product_id):
    ...
    return render(request, "inventory/clothing/product_logs.html", {
        "product": product,
        "logs": logs,
        "business": business,
    })
