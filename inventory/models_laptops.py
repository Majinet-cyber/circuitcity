...
class LaptopProduct(models.Model):
    ...
    model_name = models.CharField(
        max_length=100,
        help_text="Model name (e.g., 'ThinkPad X1', 'MacBook Pro 13')"
    )
    ...
    ram = models.CharField(
        max_length=50,
        blank=True,
        help_text="RAM specification (e.g., '8GB', '16GB DDR4')"
    )
    
    storage = models.CharField(
        max_length=50,
        blank=True,
        help_text="Storage specification (e.g., '256GB SSD', '1TB HDD')"
    )
    
    battery_life = models.CharField(
        max_length=50,
        blank=True,
        help_text="Battery life (e.g., '8 hours', '12 hours')"
    )
...
class LaptopSerial(models.Model):
    ...
    received_at = models.DateField(
        ...
        help_text="Date laptop was received/stocked"
    )
