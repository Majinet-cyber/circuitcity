...
class PhoneStockEditRequest(models.Model):
    ...
    stock = models.ForeignKey(
        "InventoryItem", on_delete=models.CASCADE, related_name="edit_requests", help_text="The stock item to be edited"
    )
    ...
    reviewed_at = models.DateTimeField(null=True, blank=True, help_text="When the request was approved/rejected")
