...
class RollbackPermissionLogicTest(TestCase):
    ...
    def setUp(self):
        ...
        Membership.objects.create(user=self.manager, business=self.business, role="MANAGER")
...
class NewVerticalsTest(TestCase):
    ...
    def test_groceries_product_creation(self):
        ...
        business = Business.objects.create(name="Test Grocery", business_kind=BusinessKind.GROCERY)
    ...
    def test_cement_product_creation(self):
        ...
        business = Business.objects.create(name="Test Hardware", business_kind=BusinessKind.CEMENT)
