...
from inventory.models_verticals import (
    GymMember, GymSettings, GymTrainer, GymMemberLog, GymMemberAction, GymMemberStatus
)
...
def _wizard_step_welcome(request, business, gym_settings):
    ...
    return render(request, "inventory/gym/wizard/step_welcome.html", {
        "business": business,
...
def _wizard_step_details(request, business, gym_settings):
    ...
    if request.method == "POST":
        ...
        if errors:
            return render(request, "inventory/gym/wizard/step_details.html", {
                "business": business,
                "gym_settings": gym_settings,
                "step": 1,
                "total_steps": 3,
...
def _wizard_step_trainer(request, business, gym_settings):
    ...
    return render(request, "inventory/gym/wizard/step_trainer.html", {
        "business": business,
        "gym_settings": gym_settings,
        "step": 2,
        "total_steps": 3,
...
def _wizard_step_confirm(request, business, gym_settings):
    ...
    return render(request, "inventory/gym/wizard/step_confirm.html", {
        "business": business,
        "gym_settings": gym_settings,
        "step": 3,
        "total_steps": 3,
...
def _wizard_step_success(request, business, gym_settings):
    ...
    return render(request, "inventory/gym/wizard/step_success.html", {
        "business": business,
        "gym_settings": gym_settings,
        "step": 4,
        "total_steps": 3,
