...
class TestCostsCommissionsDashboard(TestCase):
    ...
    def setUp(self):
        ...
        self.agent = User.objects.create_user(username="agent1", email="agent@test.com", password="password123")
    ...
    def test_net_profit_calculation(self):
        ...
        # Calculate panel
        panel = get_costs_and_commissions_panel(self.business, self.month_start, self.today)
