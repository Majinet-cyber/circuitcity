...
def notify_manager_low_stock(
    manager_user, business, product_name: str, current_qty: int, reorder_level: int = 10
) -> bool:
    """
...
def notify_near_expiry(
    manager_user, business, product_name: str, batch_number: str, expiry_date: str, days_left: int
) -> bool:
    """
