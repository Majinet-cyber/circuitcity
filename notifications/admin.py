...
class NotificationPreferenceAdmin(admin.ModelAdmin):
    list_display = [
        'user', 'welcome_emails', 'instant_sale_email', 'daily_summary_email',
        'important_alerts_email', 'high_sales_alerts', 'updated_at'
    ]
    list_filter = [
        'welcome_emails', 'instant_sale_email', 'daily_summary_email',
        'important_alerts_email', 'high_sales_alerts'
    ]
...
class NotificationEventAdmin(admin.ModelAdmin):
    list_display = [
        'event_type', 'recipient_email', 'business', 'status',
        'created_at', 'sent_at'
    ]
    ...
    fieldsets = (
        ('Event Info', {
            'fields': ('event_type', 'business', 'recipient_email', 'dedupe_key')
        }),
        ('Status', {
            'fields': ('status', 'created_at', 'sent_at', 'last_error')
        }),
        ('Payload', {
            'fields': ('payload',),
            'classes': ('collapse',)
