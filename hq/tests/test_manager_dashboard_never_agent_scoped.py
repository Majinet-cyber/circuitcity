...
class TestManagerDashboardNeverAgentScoped(TestCase):
    ...
    def test_manager_dashboard_shows_all_locations(self):
        ...
        self.assertEqual(response.status_code, 200, 
                        "Dashboard should return 200 for manager")
                ...
                if key in response.context:
                    ...
                    if hasattr(data, "count"):
                        ...
                        self.assertGreaterEqual(data.count(), 2,
                                              f"Manager should see sales from all locations in {key}")
    ...
    def test_manager_dashboard_redirects_work(self):
        ...
        self.assertEqual(response.status_code, 200,
                        "/inventory/dashboard/ should resolve without recursion")
        
        # Test /dashboard/ legacy route
        response = self.client.get("/dashboard/", follow=True)
        self.assertEqual(response.status_code, 200,
                        "/dashboard/ should resolve without recursion")
    ...
    def test_manager_sees_agents_section(self):
        ...
        has_agent_content = any(indicator.lower() in content.lower() 
                              for indicator in agent_indicators)
        
        self.assertTrue(has_agent_content,
                       "Manager dashboard should include agent-related content")
        ...
        for url in agent_urls:
            try:
                ...
                self.assertIn(response.status_code, [200, 404],
                            f"Manager should have access to agent detail at {url}, "
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    self.assertTrue(data,
                                  f"Manager should receive data from {endpoint}")
    ...
    def test_pharmacy_dashboard_no_recursion(self):
        ...
        try:
            ...
            self.assertEqual(response.status_code, 200,
                           "Pharmacy fast sell should render without recursion")
    ...
    def test_agent_cannot_access_other_agent_details(self):
        ...
        try:
            ...
            self.assertNotEqual(response.status_code, 200,
                              "Agent should not access other agent details")
        except Exception:
