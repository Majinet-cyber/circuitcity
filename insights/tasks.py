...
def forecast_daily():
    ...
    pairs = DailyKPI.objects.filter(d__gte=start_d).values_list("store_id", "product_id").distinct()
        ...
        if 0 < delta <= 2:
            ...
            try:
                ...
                Notification.objects.create(
                    ...
                    body=f"Youâ€™re {delta} phones away from #1 this week!",
                )
...
def weekly_reports():
    ...
    for m in Manager.objects.all():
        ...
        msg = EmailMultiAlternatives(
            ...
            body=text,
            from_email="no-reply@circuitcity",
            to=[m.email],
        )
