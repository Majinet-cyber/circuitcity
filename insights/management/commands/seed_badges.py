...
DEFAULTS = [
    dict(
        ...
        name="Sales Beast",
        emoji="ðŸ¥‡",
        description="30+ units in a week",
        rule={"metric": "units", "window": "week", "gte": 30},
    ),
    dict(
        code="fastest_10_today",
        name="Fastest Closer",
        emoji="ðŸš€",
        description="First to 10 sales today",
        rule={"metric": "units", "window": "day", "gte": 10, "first": True},
    ),
    dict(
        code="premium_dealer",
        name="Premium Dealer",
    ...
    dict(
        ...
        name="Streak Master",
        emoji="ðŸ”¥",
        description="1+ sale daily for 7 days",
        rule={"metric": "streak", "window": "day", "gte": 7},
    ),
]
