    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "metric",
                    models.CharField(
                        choices=[("units", "units"), ("revenue", "revenue"), ("profit", "profit")], max_length=12
                    ),
                ),
            ...
            options={
                "ordering": ["-created_at"],
                "indexes": [
                    models.Index(fields=["scope", "metric"], name="insights_le_scope_37cdcf_idx"),
                    models.Index(fields=["-created_at"], name="insights_le_created_36422b_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "run",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="items", to="insights.forecastrun"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "product",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="inventory.product"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            options={
                "ordering": ["-created_at"],
                "indexes": [
                    models.Index(fields=["report_key"], name="insights_em_report__c3c9f3_idx"),
                    models.Index(fields=["-created_at"], name="insights_em_created_3b3027_idx"),
                ],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(fields=["store_id", "product"], name="insights_re_store_i_66fcba_idx"),
                    models.Index(fields=["created_at"], name="insights_re_created_f9e4a7_idx"),
                ],
            },
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "kind",
                    models.CharField(
                        choices=[("low_stock", "Low Stock"), ("nudge", "Nudge"), ("report", "Report")], max_length=40
                    ),
                ),
                ...
                (
                    "severity",
                    models.CharField(
                        choices=[("info", "info"), ("warn", "warn"), ("crit", "crit")], default="info", max_length=10
                    ),
                ),
                ("meta", models.JSONField(blank=True, default=dict)),
            ...
            options={
                "ordering": ["-created_at"],
                "indexes": [
                    models.Index(fields=["user", "-created_at"], name="insights_no_user_id_c14146_idx"),
                    models.Index(fields=["kind"], name="insights_no_kind_0130c7_idx"),
                    models.Index(fields=["severity"], name="insights_no_severit_1dfcd3_idx"),
                ],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.AddConstraint(
            model_name="dailykpi",
            constraint=models.UniqueConstraint(
                fields=("store_id", "product", "d"), name="uniq_dkpi_storeid_product_day"
            ),
        ),
        migrations.AddIndex(
