...
class LiquorRollbackService:
    ...
    def rollback_liquor_sale(
        ...
        try:
            ...
            # Get the liquor sale
            try:
                sale = LiquorSale.objects.select_for_update().get(id=sale_id, business=business)
...
class ClothingRollbackService:
    ...
    def rollback_clothing_sale(
        ...
        try:
            ...
            try:
                sale = ClothingSale.objects.select_for_update().get(id=sale_id, business=business)
            ...
            if return_to_stock:
                ...
                if hasattr(product, "quantity"):
                    ...
                    logger.info(f"Restored {sale.quantity} units of {product.name} " f"(new stock: {product.quantity})")
