...
class TestPharmacyFastSellRegression:
    ...
    def test_pharmacy_fast_sell_returns_200(self, client: Client):
        ...
        business = make_business(created_by=user, kind=BusinessKind.PHARMACY, name="Test Pharmacy")
    ...
    def test_pharmacy_fast_sell_template_no_recursion(self, client: Client):
        ...
        business = make_business(created_by=user, kind=BusinessKind.PHARMACY, name="Test Pharmacy 2")
        location = make_location(business=business, name="Main Store")
        make_membership(
            business=business,
            user=user,
    ...
    def test_pharmacy_fast_sell_api_endpoints_work(self, client: Client):
        ...
        business = make_business(created_by=user, kind=BusinessKind.PHARMACY, name="Test Pharmacy 3")
        location = make_location(business=business, name="Main Store")
        make_membership(
            business=business,
            user=user,
