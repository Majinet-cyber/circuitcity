...
def log_audit(
    request: HttpRequest, action: str, entity: str = "", entity_id: str = "", message: str = ""
) -> Optional[AuditLog]:
    """
...
def log_hq_action(
    request: HttpRequest, action: str, entity_type: str = "", entity_id=None, message: str = "", business=None
) -> Optional[AuditLog]:
    """
