...
class TestTwoFALoginChallenge:
    ...
    def test_login_redirects_to_challenge_when_2fa_enabled(self, client, user, mock_twilio_verify, twilio_enabled_settings):
...
class TestTwoFARateLimits:
    ...
    def test_max_8_verify_attempts_per_10_minutes(self, client_logged_in, user, mock_twilio_verify, twilio_enabled_settings):
        ...
        mock_twilio_verify.return_value.verify.v2.services.return_value.verification_checks.create.return_value.status = 'pending'
...
class TestTwoFAMiddleware:
    ...
    def test_middleware_blocks_access_without_2fa_challenge(self, client, user, mock_twilio_verify, twilio_enabled_settings):
    ...
    def test_middleware_allows_access_after_passing_2fa(self, client, user, mock_twilio_verify, twilio_enabled_settings):
