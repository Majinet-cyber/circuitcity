...
class TestPayChanguWebhookSignature:
    ...
    def test_webhook_rejects_invalid_signature(self, transaction):
        ...
        response = client.post(
            url, data=payload_bytes, content_type="application/json", HTTP_SIGNATURE="invalid-signature-xyz"
        )
    ...
    def test_webhook_accepts_valid_signature_and_updates_transaction(self, mock_verify, transaction):
        ...
        signature = self.compute_signature(payload_bytes, "test-webhook-secret-12345")

        # Send with valid signature
        response = client.post(url, data=payload_bytes, content_type="application/json", HTTP_SIGNATURE=signature)
    ...
    def test_webhook_accepts_x_signature_header(self, mock_verify, transaction):
        ...
        response = client.post(url, data=payload_bytes, content_type="application/json", HTTP_X_SIGNATURE=signature)
    ...
    def test_webhook_no_cross_tenant_leakage(self, mock_verify, setup_data, transaction):
        ...
        other_business = make_business(created_by=other_user, name="Other Biz", slug="other-biz")
...
class TestPayChanguSignatureVerification:
    ...
    def test_verify_webhook_signature_valid(self):
        ...
        expected_sig = hmac.new(b"my-secret-key", payload, hashlib.sha256).hexdigest()
