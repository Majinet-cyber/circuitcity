    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "Your business name (e.g., Mo Touch Electronics)"}
            )
        }
    ...
    def clean_name(self):
        ...
        try:
            ...
            if name.replace(" ", "").isdigit():
                raise ValidationError("Store name cannot be only numbers. Please enter a proper business name.")
            return name
...
class ManagerSignupForm(forms.Form):
    ...
    email = forms.EmailField(
        ...
        widget=forms.EmailInput(
            attrs={"class": "form-control", "placeholder": "your@email.com", "autocomplete": "email"}
        ),
    ...
    password1 = forms.CharField(
        ...
        widget=forms.PasswordInput(
            attrs={"class": "form-control", "placeholder": "Create a strong password", "autocomplete": "new-password"}
        ),
        min_length=12,
    ...
    password2 = forms.CharField(
        ...
        widget=forms.PasswordInput(
            attrs={"class": "form-control", "placeholder": "Confirm your password", "autocomplete": "new-password"}
        ),
        min_length=12,
    )
