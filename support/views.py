...
def manager_ticket_list(request):
    ...
    tickets = Ticket.objects.filter(business=business).select_related("creator", "assigned_to", "resolved_by")
    ...
    return render(
        request,
        "support/manager_ticket_list.html",
        {
...
def manager_ticket_create(request):
    ...
    return render(
        request,
        "support/manager_ticket_create.html",
        {
            "form": form,
        },
    )
...
def manager_ticket_detail(request, pk):
    ...
    return render(
        request,
        "support/manager_ticket_detail.html",
        {
            "ticket": ticket,
            "comments": comments,
            "form": form,
...
def hq_ticket_list(request):
    ...
    tickets = Ticket.objects.all().select_related("business", "creator", "assigned_to", "resolved_by")
    ...
    if search:
        tickets = tickets.filter(
            Q(reference__icontains=search) | Q(subject__icontains=search) | Q(description__icontains=search)
        )
